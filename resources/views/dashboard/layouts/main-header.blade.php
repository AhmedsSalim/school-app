 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{ url('/') }}"><img src="assets/images/logo-dark.png" alt=""></a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}"><img src="assets/images/logo-icon-dark.png"
                        alt=""></a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown ">
                    <a href="index.html" class="navbar-brand" >
                        <h1 class="m-0 text-primary" style="font-family: 'Lobster Two', cursive;
                        font-weight: 600;
                        color: green !important;">First Lebanon School</h1>
                    </a>
                </li>
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="true" aria-expanded="false">
                        <img src="assets/images/First Lebanon School.jpeg" alt="avatar" width="80px" height="80px">
                    </a>
